...
$(document).ready(function () {
  ...
  // NOTE: For this to work with AJAX you MUST BE HOSTING A SIMPLE LOCAL SERVER!! Use the extension in bottom right to go live, otherwise you get CORS errors
  function getSatelliteMetaData() {
    ...
    /* console.log("getting satellite meta data...")
    return new Promise((resolve) => [
      setTimeout(() => {
        var xobj = new XMLHttpRequest();        
        xobj.overrideMimeType("application/json");
        xobj.open('GET', './assets/newest.json', true);
        console.log("in function", xobj.readyState, xobj.status);
